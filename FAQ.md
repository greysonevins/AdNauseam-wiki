...
* For Firefox use this article [here](https://support.mozilla.org/en-US/kb/troubleshoot-issues-with-plugins-fix-problems#w_manually-uninstalling-a-plugin).

* For Chrome use this article [here](https://support.google.com/chromebook/answer/2589434?hl=en).

* For Opera use this article [here](http://help.opera.com/Mac/11.60/en/extensions.html).
